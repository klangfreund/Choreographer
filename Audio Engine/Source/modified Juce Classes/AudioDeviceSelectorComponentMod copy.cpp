/*
  ...
  ------------------------------------------------------------------------------
   ...
   Slightly modified by sam:
    Line 439-443 are outcommented to hide the "Test"-Button. Thats all.
...
//==============================================================================
class AudioDeviceSelectorComponentMod::MidiInputSelectorComponentListBox  : public ListBox,
public ListBoxModel
{
public:
    //==============================================================================
...
AudioDeviceSelectorComponentMod::~AudioDeviceSelectorComponentMod()
{
    deviceManager.removeChangeListener (this);
}

void AudioDeviceSelectorComponentMod::resized()
{
    const int lx = proportionOfWidth (0.35f);
    const int w = proportionOfWidth (0.4f);
    const int h = 24;
...
void AudioDeviceSelectorComponentMod::childBoundsChanged (Component* child)
{
    if (child == audioDeviceSettingsComp)
        resized();
}

void AudioDeviceSelectorComponentMod::buttonClicked (Button*)
{
...
void AudioDeviceSelectorComponentMod::comboBoxChanged (ComboBox* comboBoxThatHasChanged)
{
...
void AudioDeviceSelectorComponentMod::changeListenerCallback (ChangeBroadcaster*)
{
    if (deviceTypeDropDown != 0)
    {
