...
#ifndef __JUCE_AUDIODEVICESELECTORCOMPONENTMOD_JUCEHEADER__
#define __JUCE_AUDIODEVICESELECTORCOMPONENTMOD_JUCEHEADER__
...
#endif   // __JUCE_AUDIODEVICESELECTORCOMPONENTMOD_JUCEHEADER__
